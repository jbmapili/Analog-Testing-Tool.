        ...
        private void Analog_Value(int value, int tag)
        {
            try
            {
                ...
                if (opc.Write(target, val, out nErrorArray))
                {
                    ...
                    string[] row = new string[] { DateTime.Now.ToString(), tag_no[tag].Text, reg_no[tag].Text, "Write", "Success" };
                    data1.Rows.Add(row);
                }
                else
                {
                    ...
                    string[] row = new string[] { DateTime.Now.ToString(), tag_no[tag].Text, reg_no[tag].Text, "Write", "Error" };
                    data1.Rows.Add(row);
                }
                short[] wQualityArray;
                ...
                if (opc.Read(target, out val, out wQualityArray, out fTimeArray, out nErrorArray) == true)
                {
                    ...
                    string[] row = new string[] { DateTime.Now.ToString(), tag_no[tag].Text, reg_no[tag].Text, "Read", "Success" };
                    data1.Rows.Add(row);
                }
                else
                {
                    ...
                    string[] row = new string[] { DateTime.Now.ToString(), tag_no[tag].Text, reg_no[tag].Text, "Read", "Error" };
                    data1.Rows.Add(row);
                }
                sw.Close();
            }
